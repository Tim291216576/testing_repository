...
<div id='createLinkage'>
  <?php extCommonModel::printLink('workflowlinkage', 'create', "action=$action->id", "<i class='icon-plus'> </i>" . $lang->workflowlinkage->create, "class='btn btn-primary loadInModal'");?>
</div>
  ...
  <table class='table table-fixed' id='linkageTable'>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class='actions'>
          <?php extCommonModel::printLink('workflowlinkage', 'edit',   "action=$action->id&key=$key", $lang->edit, "class='edit loadInModal'");?>
