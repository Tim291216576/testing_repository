...
$config->workflowdatasource->methods['project']     = array('getPairs', 'getRelatedProjects', 'getChildProjects', 'getTeamMemberPairs', 'getTeams2Import', 'getProjectBranches');
$config->workflowdatasource->methods['search']      = array('getQueryPairs');
$config->workflowdatasource->methods['story']       = array('getProductStoryPairs', 'getProjectStoryPairs', 'getUserStoryPairs', 'getProjectMembers', 'getVersions');
...
$config->workflowdatasource->methods['user']        = array('getPairs', 'getCommiters', 'getUserRoles', 'getGroups', 'getContactLists', 'getListByAccount', 'getContactUserPairs');
...
$config->workflowdatasource->langList['projectType']   = array('module' => 'project', 'field' => 'typeList');
$config->workflowdatasource->langList['projectAcl']    = array('module' => 'project', 'field' => 'aclList');
$config->workflowdatasource->langList['projectStatus'] = array('module' => 'project', 'field' => 'statusList');
