...
$lang->workflowdatasource->default->options['user']        = '系統用戶';
$lang->workflowdatasource->default->options['dept']        = '系統部門';
$lang->workflowdatasource->default->options['deptManager'] = '部門經理';
$lang->workflowdatasource->default->options['today']       = '操作日期';
$lang->workflowdatasource->default->options['now']         = '操作時間';
$lang->workflowdatasource->default->options['actor']       = '操作人';
$lang->workflowdatasource->default->options['form']        = '表單數據';
$lang->workflowdatasource->default->options['record']      = '當前數據';
$lang->workflowdatasource->default->options['custom']      = '自定義項';
