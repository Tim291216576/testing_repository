...
<form id='ajaxForm' method='post' action='<?php echo inlink('create', "module=$flow->module");?>'>
  <table class='table table-form' id='actionTable'>
    ...
    <tr>
      ...
      <td><a data-toggle='tooltip' data-tip-class='tooltip-primary' title='<?php echo $lang->workflowaction->tips->position;?>'><i class='icon-question-sign'></i></a></td>
    </tr>
    <tr>
      <th><?php echo $lang->workflowaction->show;?></th>
      <td><?php echo html::select('show', $lang->workflowaction->showList, '0', "class='form-control'");?></td>
      <td><a data-toggle='tooltip' data-tip-class='tooltip-primary' title='<?php echo $lang->workflowaction->tips->show;?>'><i class='icon-question-sign'></i></a></td>
    </tr>
    <tr>
