...
$lang->workflowaction->tips->position    = 'The action will dock on right of the flow menu if it displays in a menu. Dock on right of each record in the table, if it displays a list page. Dock on the bottom of the detail page, if it displays the view page.';
