...
$lang->workfloweditor->switchConfirmMessage  = '將切換到高級工作流編輯器，<br>您可以在高級編輯器進行擴展設置、標籤設計和明細表設計等操作。<br>確定切換嗎？';
...
$lang->workfloweditor->advanceSteps['setting']   = array('link' => '更多設置|workflowrelation|admin', 'subMenu' => array('workflowfield' => 'setExport,setSearch', 'workflow' => 'setjs,setcss'));
