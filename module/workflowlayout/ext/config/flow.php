...
$config->workflowlayout->buildin->layouts->product->browse['name']    = array('width' => 200,    'mobileShow' => 1);
...
$config->workflowlayout->buildin->layouts->product->browse['status']  = array('width' => 100,    'mobileShow' => 1);
...
$config->workflowlayout->buildin->layouts->story->browse['pri']        = array('width' => 50,     'mobileShow' => 1);
$config->workflowlayout->buildin->layouts->story->browse['title']      = array('width' => 'auto', 'mobileShow' => 1);
...
$config->workflowlayout->buildin->layouts->story->browse['status']     = array('width' => 80,     'mobileShow' => 1);
$config->workflowlayout->buildin->layouts->story->browse['stage']      = array('width' => 100,    'mobileShow' => 1);
...
$config->workflowlayout->buildin->layouts->productplan->browse['title']   = array('width' => 160,    'mobileShow' => 1);
$config->workflowlayout->buildin->layouts->productplan->browse['begin']   = array('width' => 120,    'mobileShow' => 1);
$config->workflowlayout->buildin->layouts->productplan->browse['end']     = array('width' => 120,    'mobileShow' => 1);
...
$config->workflowlayout->buildin->layouts->release->browse['name']    = array('width' => 200,    'mobileShow' => 1);
$config->workflowlayout->buildin->layouts->release->browse['build']   = array('width' => 200,    'mobileShow' => 1);
$config->workflowlayout->buildin->layouts->release->browse['date']    = array('width' => 100,    'mobileShow' => 1);
$config->workflowlayout->buildin->layouts->release->browse['status']  = array('width' => 80,    'mobileShow' => 1);
...
$config->workflowlayout->buildin->layouts->project->browse['name']    = array('width' => 'auto', 'mobileShow' => 1);
$config->workflowlayout->buildin->layouts->project->browse['code']    = array('width' => 100,    'mobileShow' => 1);
$config->workflowlayout->buildin->layouts->project->browse['PM']      = array('width' => 100,    'mobileShow' => 1);
$config->workflowlayout->buildin->layouts->project->browse['end']     = array('width' => 100,    'mobileShow' => 1);
$config->workflowlayout->buildin->layouts->project->browse['status']  = array('width' => 100,    'mobileShow' => 1);
...
$config->workflowlayout->buildin->layouts->task->browse['pri']        = array('width' => 50,     'mobileShow' => 1);
$config->workflowlayout->buildin->layouts->task->browse['name']       = array('width' => 'auto', 'mobileShow' => 1);
$config->workflowlayout->buildin->layouts->task->browse['status']     = array('width' => 120,    'mobileShow' => 1);
$config->workflowlayout->buildin->layouts->task->browse['assignedTo'] = array('width' => 120,    'mobileShow' => 1);
...
$config->workflowlayout->buildin->layouts->build->browse['product']  = array('width' => 200,    'mobileShow' => 1);
$config->workflowlayout->buildin->layouts->build->browse['id']       = array('width' => 70,     'mobileShow' => 0);
$config->workflowlayout->buildin->layouts->build->browse['name']     = array('width' => 'auto', 'mobileShow' => 1);
...
$config->workflowlayout->buildin->layouts->build->browse['date']     = array('width' => 100,    'mobileShow' => 1);
$config->workflowlayout->buildin->layouts->build->browse['builder']  = array('width' => 80,     'mobileShow' => 1);
...
$config->workflowlayout->buildin->layouts->bug->browse['severity']   = array('width' => 60,     'mobileShow' => 1);
$config->workflowlayout->buildin->layouts->bug->browse['pri']        = array('width' => 50,     'mobileShow' => 1);
$config->workflowlayout->buildin->layouts->bug->browse['title']      = array('width' => 'auto', 'mobileShow' => 1);
$config->workflowlayout->buildin->layouts->bug->browse['status']     = array('width' => 80,     'mobileShow' => 1);
...
$config->workflowlayout->buildin->layouts->testcase->browse['pri']           = array('width' => 40,     'mobileShow' => 1);
$config->workflowlayout->buildin->layouts->testcase->browse['title']         = array('width' => 'auto', 'mobileShow' => 1);
$config->workflowlayout->buildin->layouts->testcase->browse['type']          = array('width' => 90,     'mobileShow' => 1);
...
$config->workflowlayout->buildin->layouts->testcase->browse['status']        = array('width' => 70,     'mobileShow' => 1);
...
$config->workflowlayout->buildin->layouts->testtask->browse['name']    = array('width' => 200,    'mobileShow' => 1);
...
$config->workflowlayout->buildin->layouts->testtask->browse['owner']   = array('width' => 80,     'mobileShow' => 1);
$config->workflowlayout->buildin->layouts->testtask->browse['begin']   = array('width' => 100,    'mobileShow' => 1);
$config->workflowlayout->buildin->layouts->testtask->browse['end']     = array('width' => 100,    'mobileShow' => 1);
$config->workflowlayout->buildin->layouts->testtask->browse['status']  = array('width' => 80,     'mobileShow' => 1);
...
$config->workflowlayout->buildin->layouts->testsuite->browse['name']      = array('width' => 200,    'mobileShow' => 1);
$config->workflowlayout->buildin->layouts->testsuite->browse['desc']      = array('width' => 'auto', 'mobileShow' => 1);
...
$config->workflowlayout->buildin->layouts->caselib->browse['name']      = array('width' => 200,    'mobileShow' => 1);
$config->workflowlayout->buildin->layouts->caselib->browse['desc']      = array('width' => 'auto', 'mobileShow' => 1);
...
$config->workflowlayout->buildin->layouts->feedback->browse['product']    = array('width' => 120,    'mobileShow' => 1);
$config->workflowlayout->buildin->layouts->feedback->browse['title']      = array('width' => 'auto', 'mobileShow' => 1);
$config->workflowlayout->buildin->layouts->feedback->browse['status']     = array('width' => 80,     'mobileShow' => 1);
...
$config->workflowlayout->buildin->layouts->feedback->browse['assignedTo'] = array('width' => 120,    'mobileShow' => 1);
